        ...
        <div className={cn("min-w-0 flex-1", classNames?.content)}>
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <p
                className={cn("truncate text-sm font-medium text-foreground", classNames?.name)}>
                {item.name}
              </p>
          ...
          {showProgress ? (
            <div
              ...
              className={cn("mt-3 h-1.5 overflow-hidden rounded-full bg-muted", classNames?.progress)}>
              <motion.div
                className={cn("h-full rounded-full", status === "success"
                  ? "bg-emerald-500"
                  : "bg-foreground")}
                style={{
  ...
  return (
    <div className={cn("w-full space-y-3", className, classNames?.root)}>
      ...
      <button
        ...
        <motion.span
          aria-hidden="true"
          className={cn("grid shrink-0 place-items-center bg-muted text-foreground", centered
        ...
        <span className={cn("min-w-0", centered ? "max-w-xs" : "flex-1")}>
          <span
            className={cn("block font-semibold text-foreground", centered ? "text-base" : "text-sm")}>
